...
function Order() {
  ...
  const handleTrackOrder = () => {
    if (!orderId) {
      toast.warning("Order ID not found");
      return;
    }
                ...
                <div className="order-box">
                  ...
                  <div className="order-contain text-center">
                    ...
                    <h5 className="text-content">
                      Thank You for Your Order! We truly appreciate your
                      purchase! Your support means the world to us. If you have
                      any questions or need assistance, feel free to reach out.
                      Enjoy your shopping experience!
                    </h5>
                    <h6>Your Order ID: {orderId}</h6>
                  </div>
                </div>
